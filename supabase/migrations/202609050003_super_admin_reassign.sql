-- ============================================================
-- Super Admin: Reassign Student
-- ============================================================
-- Moves an existing active allocation to another available bed.
...
BEGIN
    ...
    -- Lock and validate the new room.
    SELECT *
    INTO v_new_room
    FROM public.rooms
    ...
    -- Respect the existing room gender rules.
    v_room_gender :=
    ...
    -- Lock the old room for consistency.
    SELECT *
    INTO v_old_room
    FROM public.rooms
